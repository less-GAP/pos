<script>function main(props) {
    let {Api, plugin, computed, h, compile, ref, modelManager, reactive, currentRoute, router} = props;
    const self = this;
    Object.assign(this, props);
    this.store = modelManager.model('user').find(currentRoute.value.params.id, {include: 'roles'},{
