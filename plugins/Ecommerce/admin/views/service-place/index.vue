...
function main(props) {
    ...
    this.prefix = '/ecommerce/service-place'
    const routePrefix = this.prefix
    const self = this
    this.store = modelManager.model('taxonomy').paginate({'filter[type]':'service-place'})
    const itemActions = [
        {
            label: 'Edit Category',
            icon: 'fa fa-edit',
    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                ...
                <router-link :to="plugin.url('/service-place/new')" class="btn btn-added"><img
